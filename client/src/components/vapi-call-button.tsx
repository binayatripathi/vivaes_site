    ...
    try {
      await vapi.start(VAPI_ASSISTANT_ID, {
        variableValues: {
          ...
          services: "Solar & Storage, Battery Storage Add-On, EV Chargers, Panel Upgrades, Lighting Retrofits, General Electrical, Commercial Electrical, Electrification Assessment, Re-Roofing + Panel Removal/Reinstall, Warehouse/Commercial, EV Charger + Panel Upgrade + Battery Bundle",
          businessContext: [
            ...
            "Services: Solar + Battery new system, Battery add-on to existing solar, EV charger installation, Electrical panel upgrades, LED lighting retrofits, General electrical, Commercial electrical and solar, Electrification assessments, Re-roofing with solar panel removal and reinstall, Warehouse/commercial electrical, EV Charger + Panel Upgrade + Battery bundle.",
            ...
            "IMPORTANT PRICING (always frame as 'from X and up — final pricing based on site inspection'): EV chargers from $850 and up depending on amperage and on-site evaluation. Panel upgrades from $3,500 and up depending on site conditions. Solar + Battery new system from $30,000 and up depending on system configuration. Lighting retrofits from $600 and up depending on lighting needs and on-site evaluation. General electrical from $600 and up. Commercial electrical from $600 and up. Battery add-on to existing solar from $15,500 and up depending on energy storage needs. Battery backup only (no solar) from $15,500 and up. Electrification assessment is $250. Solar panel detach and reset for re-roofing $325 to $575 per panel depending on racking type and system age. EV Charger + Panel Upgrade + Battery bundle from $28,000 and up. Permit and inspection fees are $500 and up.",
            "Battery storage sizes available: 5 kW, 10 kW, 13.5 kW, or 15 kW depending on energy storage needs.",
            "IMPORTANT: Never mention labor, material, equipment, or site prep costs separately. Always give a single 'from X and up' range. Final pricing is always based on site inspection.",
            "On-site consultations are $250. Electrification assessments are $250. There are no free assessments or free consultations.",
            "All work is performed by licensed electricians. Full warranty on labor and materials.",
            "Available 24/7 for emergency service.",
            "You can help callers with: general questions about our services, scheduling appointments, providing rough cost estimates as ranges (from X and up), taking down their information for a callback, and answering questions about solar energy, battery storage, electrification rebates, EV charging, electrical safety, and permits.",
          ].join(" "),
        },
      });
    } catch (err: any) {
